...
/**
 * Class to interact with cps database.
 *
 * @function create: inserts document, can overwrite existing document
 * @function fetch: fetch document by id
 * @function delete: deletes document
 * @function update: updates document merging in passed keys
 * @function replace: overwrites document
 *
 * ACID functions
